...
parser.add_argument('--alg', type=str, metavar='N', help='optimizer, one of swa/sghmc/de')
...
parser.add_argument('--ensemble_num', type=int, default=5, metavar='N', help='num of ensemble for deep ens(default:5 )')
...
parser.add_argument('--sgd_lr', type=float, default=0.01, metavar='N', help='lr of sgd for deep ens(default: 0.01 )')
